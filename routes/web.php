...
Route::get('/', function () {
  ...
  Route::post('{id}/settings', 'User\UserController@getAccountSettings')->name('account.settings.update');
  Route::post('{id}/settings/privacy', 'User\UserController@getAccountSettings')->name('account.privacy.update');
  Route::post('{id}/settings/change/password', 'User\UserController@getAccountSettings')->name('account.changepass.update');
